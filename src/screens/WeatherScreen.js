...
export default function WeatherScreen({ navigation }) {
    ...
    const [weatherOutside, setWeatherOutside] = useState({
        ...
        kelembapanLuar: 85,
        kecepatanAngin: 12,
        terakhirUpdate: '02:30 WIB'
    });

    const [advisoryMsg, setAdvisoryMsg] = useState({
        status: 'Waspada',
        pesan: 'Cuaca luar sedang hujan dengan kelembapan tinggi. Sistem mendeteksi potensi penurunan suhu tajam di dalam inkubator.',
    ...
    return (
        <View style={styles.container}>
            ...
            {/* Header Atas - Badge Lokasi Menggunakan Tulisan Biasa */}
            ...
            >
                ...
                <View style={[styles.advisoryCard, advisoryMsg.status === 'Waspada' ? styles.borderWarning : styles.borderSafe]}>
                    ...
                    {/* Langkah Rekomendasi Menggunakan Tulisan Biasa */}
                    <View style={styles.actionBox}>
                        <Text style={styles.actionTitle}>Langkah Rekomendasi:</Text>
                        <Text style={styles.actionBody}>{advisoryMsg.tindakan}</Text>
                    </View>
                </View>

                {/* Prakiraan Cuaca Terdekat */}
...
const styles = StyleSheet.create({
    ...
    weatherCard: { backgroundColor: '#FFFFFF', borderRadius: 24, padding: 20, elevation: 2, marginBottom: 24 },
